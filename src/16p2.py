...
starts = [
    ...
    (0, mc, RIGHT), (0, mc, UP),
    (mr, 0, LEFT), (mr, 0, DOWN),
    (mr, mc, RIGHT), (mr, mc, UP),
]
starts.extend((0, c, UP) for c in range(1, mc))
starts.extend((mr, c, DOWN) for c in range(1, mc))
starts.extend((r, 0, LEFT) for r in range(1, mr))
starts.extend((r, mc, RIGHT) for r in range(1, mr))
...
for start in starts:
    ...
    this_visited = len(count_visited.keys())
